...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DOUBLE_TEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Dashes aboout to create illusory\n"
            "copies. Raises evasiveness."),
    ...
    [MOVE_BIDE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Endures attack for 2 turns,\n"
            "then retaliates double."),
        .effect = EFFECT_BIDE,
        .power = 1,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_HIGH_JUMP_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A jumping kick. If it misses,\n"
            "the user takes extreme damage."),
        .power = 150,
        .effect = EFFECT_RECOIL_IF_MISS,
        .type = TYPE_FIGHTING,
        .accuracy = 85,
    ...
    [MOVE_DREAM_EATER] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_CALM_MIND, COMBO_STARTER_HYPNOSIS, COMBO_STARTER_LOVELY_KISS, COMBO_STARTER_SPORE, COMBO_STARTER_SING, COMBO_STARTER_YAWN, COMBO_STARTER_DARK_VOID, COMBO_STARTER_LEAF_WHISTLE, COMBO_STARTER_SLEEP_POWDER},
    ...
    [MOVE_NIGHTMARE] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_LOVELY_KISS, COMBO_STARTER_SPORE, COMBO_STARTER_SING, COMBO_STARTER_YAWN, COMBO_STARTER_HYPNOSIS, COMBO_STARTER_DARK_VOID, COMBO_STARTER_LEAF_WHISTLE, COMBO_STARTER_SLEEP_POWDER},
    ...
    [MOVE_PROTECT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Protects the user. May\n"
            "fail on successive use."),
    ...
    [MOVE_FEINT_ATTACK] =
    {
        ...
        .description = COMPOUND_STRING(
            "Draws close, then throws a\n"
            "sucker punch. Always hits."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    [MOVE_BELLY_DRUM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Maxes Attack but sacrifices\n"
            "half of the user's max HP."),
    ...
    [MOVE_DYNAMIC_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful and inaccurate punch\n"
    ...
    [MOVE_REVENGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user strikes after the\n"
            "foe moves. Gains power if hit."),
    ...
    [MOVE_BRICK_BREAK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful chop attack that\n"
            "destroys defensive barriers."),
    ...
    [MOVE_YAWN] =
    {
        ...
        .description = COMPOUND_STRING(
            "A contagious yawn that puts\n"
            "the foe to sleep next turn."),
        .effect = EFFECT_YAWN,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_FEATHER_DANCE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "feathers. Sharply reduces Attack."),
        .effect = EFFECT_ATTACK_DOWN_2,
        .power = 0,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_MUD_SPORT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Covers the field in mud to\n"
            "weaken Electric-type moves."),
    ...
    [MOVE_ASTONISH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A surprise attack that may\n"
            "shock the foe into flinching."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_METAL_SOUND] =
    {
        ...
        .description = COMPOUND_STRING(
            "Clangs together its metal\n"
            "to sharply lower Sp. Def."),
        .effect = EFFECT_SPECIAL_DEFENSE_DOWN_2,
        .power = 0,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_LEAF_WHISTLE] =
    {
        .name = COMPOUND_STRING("Leaf Whistle"),
        .description = COMPOUND_STRING(
        ...
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_AVOID_STARTLE_ONCE : CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = COMBO_STARTER_LEAF_WHISTLE,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_LeafWhistle,
        .validApprenticeMove = TRUE,
    },
    ...
    [MOVE_MUDDY_WATER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Slams the foe with muddy\n"
            "water. May lower accuracy."),
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_WATER,
        .dualType = TYPE_GROUND,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
        .priority = 0,
    ...
    [MOVE_HOWL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Howls to boost spirits.\n"
            "Raises the team's Attack."),
        .power = 0,
    ...
    [MOVE_BOUNCE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Bounces up, then strikes down\n"
            "the next turn. May paralyze."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = 80,
        .type = TYPE_FLYING,
        .accuracy = 95,
    ...
    [MOVE_WAKE_UP_SLAP] =
    {
        ...
        .contestCategory = C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_LOVELY_KISS, COMBO_STARTER_SPORE, COMBO_STARTER_ENTRAINMENT, COMBO_STARTER_PLAY_NICE, COMBO_STARTER_SING, COMBO_STARTER_YAWN, COMBO_STARTER_HYPNOSIS, COMBO_STARTER_DARK_VOID, COMBO_STARTER_LEAF_WHISTLE, COMBO_STARTER_SLEEP_POWDER},
    ...
    [MOVE_HAMMER_ARM] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user slams down a heavy fist.\n"
    ...
    [MOVE_CLOSE_COMBAT] =
    {
        ...
        .description = COMPOUND_STRING(
            "A risky, up-close attack. Lowers\n"
    ...
    [MOVE_FLARE_BLITZ] =
    {
        ...
        .description = COMPOUND_STRING(
            "A fiery charge that hurts\n"
            "the user. May cause a burn."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_MUD_BOMB] =
    {
        ...
        .description = COMPOUND_STRING(
            "Launches a blob of mud at\n"
            "the foe. May cut accuracy."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_GROUND,
        .accuracy = 90,
    ...
    [MOVE_WOOD_HAMMER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Slams with the force of its\n"
            "entire body. Recoil damage."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_WIDE_GUARD] =
    {
        ...
        .description = COMPOUND_STRING(
            "Protects the user's team\n"
            "from wide-range attacks."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
    ...
    [MOVE_TELEKINESIS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Makes the foe float in the air.\n"
    ...
    [MOVE_FLAME_CHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Tackles the foe in a body\n"
            "of fire. Raises Speed."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_HEX] =
    {
        ...
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_TOXIC, COMBO_STARTER_FORCE_PALM, COMBO_STARTER_THUNDER_WAVE, COMBO_STARTER_INFERNO, COMBO_STARTER_WILL_O_WISP, COMBO_STARTER_LOVELY_KISS, COMBO_STARTER_SPORE, COMBO_STARTER_SING, COMBO_STARTER_YAWN, COMBO_STARTER_HYPNOSIS, COMBO_STARTER_DARK_VOID, COMBO_STARTER_LEAF_WHISTLE, COMBO_STARTER_SLEEP_POWDER, COMBO_STARTER_POISON_GAS, COMBO_STARTER_POISON_POWDER, COMBO_STARTER_TOXIC_SPIKES, COMBO_STARTER_GLARE},
    ...
    [MOVE_ACROBATICS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Damage doubles if no item\n"
            "is weighing the user down."),
    ...
    [MOVE_INFERNO] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful, inaccurate fire\n"
            "that burns if it hits."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIRE,
        .accuracy = 60,
    ...
    [MOVE_THORNY_SHIELD] =
    {
        ...
        .priority = 4,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .protectMethod = PROTECT_THORNY_SHIELD },
        .zMove = { .effect = Z_EFFECT_DEF_UP_1 },
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_ThornyShield,
    },
    ...
    [MOVE_STOMPING_TANTRUM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Stomps around angrily. Stronger\n"
            "if the move before failed."),
    ...
    [MOVE_NO_RETREAT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Raises all stats. The user\n"
            "cannot escape after use."),
    ...
    [MOVE_DUAL_WINGBEAT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Slams the target with spread\n"
            "wings. Hits twice in a row."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FLYING,
        .accuracy = 90,
    ...
    [MOVE_CEASELESS_EDGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "An endless and cutting pain from\n"
            "a sharpened edge. Never misses."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_STEEL,
        .dualType = TYPE_DARK,
    ...
    [MOVE_LEAF_RUSH] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = gBattleAnimMove_LeafRush,
    },
